...
const (
	URLShortener_CreateShortLink_FullMethodName       = "/api.URLShortener/CreateShortLink"
	URLShortener_GetShortLink_FullMethodName          = "/api.URLShortener/GetShortLink"
	URLShortener_BatchCreateShortLinks_FullMethodName = "/api.URLShortener/BatchCreateShortLinks"
	URLShortener_GetUserURLs_FullMethodName           = "/api.URLShortener/GetUserURLs"
	URLShortener_DeleteUserURLs_FullMethodName        = "/api.URLShortener/DeleteUserURLs"
)
...
type URLShortenerClient interface {
	...
	BatchCreateShortLinks(ctx context.Context, in *BatchCreateShortLinkRequest, opts ...grpc.CallOption) (*BatchCreateShortLinkResponse, error)
...
func (c *uRLShortenerClient) BatchCreateShortLinks(ctx context.Context, in *BatchCreateShortLinkRequest, opts ...grpc.CallOption) (*BatchCreateShortLinkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type URLShortenerServer interface {
	...
	BatchCreateShortLinks(context.Context, *BatchCreateShortLinkRequest) (*BatchCreateShortLinkResponse, error)
...
func (UnimplementedURLShortenerServer) BatchCreateShortLinks(context.Context, *BatchCreateShortLinkRequest) (*BatchCreateShortLinkResponse, error) {
...
func _URLShortener_BatchCreateShortLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLShortenerServer).BatchCreateShortLinks(ctx, req.(*BatchCreateShortLinkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
